/**
 * @author chakkac5
 * creating the playlist using the circular generic linked list 
 */
...
public class CircularPlaylist {
	...
	MyCircularLinkedList<Song> list;

	CircularPlaylist(String name) {
		list = new MyCircularLinkedList<Song>();
		PlaylistName = name;
	}
	...
	boolean addSongsFrom(CircularPlaylist p) {
		if (p.list.size() > 0) {
