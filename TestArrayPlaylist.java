/**
 * @author Kswann
 * test the playlist class using the array generic list 
 */
...
public class TestArrayPlaylist {
	...
	public static void runTest() {
		...
		Song s2 = new Song("Clocks", "Cold Play", (float) 3.56);

		ArrayPlaylist p = new ArrayPlaylist("ColdPlayHits");
		p.addSong(s1);
		p.addSong(s2);
		...
		ArrayPlaylist favorites = new ArrayPlaylist("favorites");
	...
	public static void PerformanceTest() {
		...
		ArrayPlaylist p = new ArrayPlaylist("Songs");
