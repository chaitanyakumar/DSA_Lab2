/**
 * @author Kswann
 * test class to test the generic array list 
 */
public class TestArrayList {
	
	public static void runTest() {

		System.out.println("Creating an integer based array list");
		System.out.println("-------------------------------------");
		...
		MyArrayList<Integer> subList = (MyArrayList<Integer>)list.subList(2, 5);
